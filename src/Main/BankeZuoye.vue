<template>
        ...
        <div>
            ...
            >
                ...
                <div slot="bottom" class="mint-loadmore-bottom">
                    <span v-show="bottomStatus === 'drop'">上拉加载更多</span>
                    <span v-show="bottomStatus === 'loading'">加载中...</span>
                </div>

                <div v-if="zuoyelist.length==0" class="tc">
                    没有任何作业
                </div>
             </mt-loadmore>
 ...
 <script>
     ...
     export default {
         ...
         ,methods:{
             ...
             ,domenuopt(nstateto){
                 if (this.curzuoye){
                     ...
                     Indicator.open('处理中');
                     this.$http.post('/api/api/bankezuoyesetstate',
                         {
         ...
         ,destroyed(){
             this.$store.commit('setBankeData', {modulename:'zuoyelist', bankeid:this.bankeid, fn:(zobj) => {
