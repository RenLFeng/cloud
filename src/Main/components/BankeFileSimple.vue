<template>
    <div class="mainpart" @click="onclick">
        ...
        <div class="maincontent">
            <div class="mainctitle ellipse">{{fileitem.filename}}</div>
...
<script>
    ...
    export default {
        ...
        computed:{
            fileimg(){
                var r = require('../../assets/100x100.png');
                return r;
            }
            ,filesizedesc(){
                return commontools.renderFileSizeDesc(this.fileitem.filesize);
            }
            ,filetimedesc(){
               // return '11';
                var str = this.fileitem.uploadtime;
                str += ' 发布';
                return str;
            }
        }
